                ...
                echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                <div class="figure-wrap bg-image" data-image-src="admin/Res_img/dishes/'.$r['img'].'">
                                    ...
                                    <div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star">
        </i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o">
        </i> </div>
                                ...
                                <div class="content">
                                    ...
                                    <div class="price-btn-block"> <span class="price">Rs'.$r['price'].'</span> <a
        href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-
        right">Order Now</a> </div>
                                </div>
                            </div>
                        </div>';
              }	*/
...
@section('banner_part')
<!-- banner part starts -->
<section class="hero bg-image" data-image-src="{{asset('Frontend/images/img/main.jpeg')}}">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Eat Quality food without any fear... </h1>
                    <h5 class="font-white">Find what you want.. & get attractive offers with...</h5>
                    <h4 class="font-white">&</h4>
                    <h5 class="font-white">get attractive offers with...</h5>
                    <h2 class="font-white space-xs font-italic">....Food 2 Go....</h2>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Log in to our website</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery to your door-step</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
    ...
    <div class="container">
            ...
            <div class="row how-it-works-solution">
                <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                    <div class="how-it-works-wrap">
                        <div class="step step-1">
                            ...
                            <h3>Log in to Food 2 Go</h3>
                            <p>We"ve got food what you want..</p>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                    <div class="step step-2">
                        ...
                        <p>add your choice to your cart.</p>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                <p class="pay-info">Pay by Cash on delivery or online secure-way</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row text-img-block text-xs-left">
                <div class="container">
                    <div class="col-xs-12 col-sm-5 right-image text-center">
                        <figure> <img src="{{asset('Frontend/images/app.png')}}" alt="Right Image"
class="img-fluid"> </figure>
                    </div>
                    <div class="col-xs-12 col-sm-7 left-text">
                        <h3>The Best Food Delivery website</h3>
                        <p>In near future you can make food happen pretty much wherever you are thanks
to the free easy-to-use Food 2 Go App.</p>
                            </a>
                        </div>
                    </div>
                </div>
