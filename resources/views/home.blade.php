                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Log in to the website..</h3>
                                    <p>We"ve got tasty food for reasonable price.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a tasty dish what do you want...</h3>
                                <p>if you like place the order.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered! And enjoy your meal! Pay online or cash-on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="{{asset('Frontend/images/app.png')}}" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Food Delivery website</h3>
                                <p>In near future you can make food happen pretty much wherever you are thanks to the free easy-to-use Food 2 Go App.</p>
